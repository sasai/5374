# 5374 江戸川区版
 ...
 [Code for Kanazawa](http://codeforkanazawa.org/)が開発した[5374](https://github.com/codeforkanazawa-org/5374)に、[江戸川区が公開しているオープンデータ](https://www.city.edogawa.tokyo.jp/kuseijoho/open-data/index.html)を編集・加工して登録したものです。
...
江戸川区が公開しているオープンデータをもとにしています。（[江戸川区オープンデータ](https://www.city.edogawa.tokyo.jp/kuseijoho/open-data/index.html)）
